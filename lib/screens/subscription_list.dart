...
class _HomePageState extends State<ViewSubscription> {
  String user_id = '';
  String member_name = '';
  String member_code = '';
  String mobile = '';
  ...
  Future _getComplaintCategories() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/subscription-list"),
      body: {
        "member_id":user_id.toString(),
      },
      headers: headers,
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
        ...
        appBar:AppBar(
          ...
          centerTitle: true,
          title: Container(
            child: Text("Receipt List", style: normalText5),
          ),
          leading: InkWell(
              onTap: (){
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        child: Row(children: <Widget>[
                                          ...
                                          Text(
                                              _searchResult[index].last_payment_date,
                                              style: normalText1),
                                        ]),
                                      ),
                                      SizedBox(
                                      ...
                                      Container(
                                        child: Row(children: <Widget>[
                                          ...
                                          Expanded(
                                            child: Text(
                                                _searchResult[index].net_payable,
                                                maxLines: 2,
                                                softWrap: true,
                                                overflow:
                                                TextOverflow.ellipsis,
                                      ...
                                      Row(
                                          ...
                                          Row(children: <Widget>[
                                            ...
                                            SizedBox(
                                             ...
                                             Text(
                                                 _searchResult[index].subscription_paid_from,
                                                  maxLines: 2,
                                                  softWrap: true,
                                                  overflow:
                                                  TextOverflow.ellipsis,
                                            ...
                                            Container(
                                              ...
                                              Text(
                                                  _searchResult[index].subscription_paid_to,
                                                      maxLines: 2,
                                                      softWrap: true,
                                                      overflow:
                                                      TextOverflow.ellipsis,
                                          ...
                                          children: <Widget>[
                                            Container(
                                              child: Row(children: <Widget>[
                                                ...
                                                SizedBox(
                                                 ...
                                                 Text(
                                                     _searchResult[index].receipt_no,
                                                      maxLines: 2,
                                                      softWrap: true,
                                                      overflow:
                                                      TextOverflow.ellipsis,
                                            ...
                                            Container(
                                              child: Row(children: <Widget>[
                                                ...
                                                Text(
                                                    _searchResult[index].payment_mode,
                                                      maxLines: 2,
                                                      softWrap: true,
                                                      overflow:
                                                      TextOverflow.ellipsis,
                                            ...
                                            child: RichText(
                                                text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                          style: normalText10,
                                                          text: response[index]['receipt_download']??'',
                                                          recognizer: TapGestureRecognizer()..onTap =  () async{
                                                            var url = response[index]['receipt_download']??'';
                                      ...
                                      Container(
                                        ...
                                        child: ButtonTheme(
                                          ...
                                          child: RaisedButton(
                                            ...
                                            onPressed: () async {
                                              var url =   _searchResult[index].receipt_download;
                                              _launchInBrowser(url);
                                            },
                                            child: Text(
                                              "Download Receipt",
                                              style: TextStyle(fontSize: 14, letterSpacing: 1,fontWeight: FontWeight.w400),
                                            ),
                                          ),
                                        ),
                                      ),
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              Row(children: <Widget>[
                                                ...
                                                Text(
                                                    response[index]['subscription_paid_from']??'',
                                                    maxLines: 2,
                                                    softWrap: true,
                                                    overflow:
                                                    TextOverflow.ellipsis,
                                            ...
                                            Container(
                                              child: Row(
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Text(
                                                        response[index]['subscription_paid_to']??'',
                                                        maxLines: 2,
                                                        softWrap: true,
                                                        overflow:
                                                        TextOverflow.ellipsis,
                                            ...
                                            Container(
                                              child: Row(children: <Widget>[
                                                ...
                                                SizedBox(
                                                 ...
                                                 Text(
                                                      response[index]['payment_mode'].toString()??'',
                                                      maxLines: 2,
                                                      softWrap: true,
                                                      overflow:
                                                      TextOverflow.ellipsis,
...
class UserDetails {
  ...
  UserDetails(
      {this.id,
        ...
        this.subscription_paid_from,
        this.receipt_download,
        this.subscription_paid_to,
        this.payment_mode,
      });
  ...
  factory UserDetails.fromJson(Map<String, dynamic> json) {
    return new UserDetails(
      ...
      net_payable: json['net_payable']??'',
      last_payment_date: json['last_payment_date']??'',
      subscription_paid_from: json['subscription_paid_from']??'',
      subscription_paid_to: json['subscription_paid_to']??'',
      payment_mode: json['payment_mode']??'',
      receipt_download: json['receipt_download']??'',
    );
  }
}
