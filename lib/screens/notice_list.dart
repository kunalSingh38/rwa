...
class _HomePageState extends State<NoticeList> {
  String user_id = '';
  String member_name = '';
  String member_code = '';
  String mobile = '';
  ...
  Future _getComplaintCategories() async {
    ...
    var response = await http.post(
      new Uri.https(BASE_URL, API_PATH + "/notice-list"),
      body: "",
      headers: headers,
    );
    ...
    if (response.statusCode == 200) {
      ...
      var result = data['Response']['notice_list'];
      setState(() {
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
        ...
        appBar:AppBar(
          ...
          centerTitle: true,
          title: Container(
            child: Text("Notice Board", style: normalText2),
          ),
          leading: InkWell(
              onTap: (){
                                    ...
                                    children: <Widget>[
                                      Container(
                                        child: Row(children: <Widget>[
                                          ...
                                          Text(
                                              _searchResult[index].event_date,
                                              style: normalText1),
                                        ]),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: ButtonTheme(
                                          ...
                                          child: RaisedButton(
                                            ...
                                            onPressed: () async {
                                              if( _searchResult[index].file_link!="") {
                                                if(_searchResult[index].file_link.contains("pdf")) {
                                                  Navigator.pushNamed(
                                                    context,
                                                    '/pdf-view',
                                                    arguments: <String, String>{
                                                      'url': _searchResult[index].file_link,
                                                      'name': _searchResult[index].file,
                                                    },
                                                  );
                                                }
                                                else{
                                                ...
                                                if(_searchResult[index].link!=null) {
                                                  var url = _searchResult[index].link;
                                                  _launchInBrowser(url);
                                                }
                                                else{
                                                  Fluttertoast.showToast(msg: "No available link");
                                                }
                                              }
                                            },
                                            child: Text(
                                            ...
                                            child: RichText(
                                                text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                          style: normalText3,
                                                          text: response[index]['link']??'',
                                                          recognizer: TapGestureRecognizer()..onTap =  () async{
                                                            var url = response[index]['link']??'';
                                                            _launchInBrowser(url);
                                                          }
                                                      ),
                                                    ]
                                      ...
                                      Container(
                                        ...
                                        child: ButtonTheme(
                                          ...
                                          child: RaisedButton(
                                            ...
                                            color: Color(0xff54d3c0),
                                            onPressed: () async {
                                              if(response[index]['file_link'].toString()!="") {
                                                if(response[index]['file_link'].toString().contains("pdf")) {
                                                  Navigator.pushNamed(
                                                    context,
                                                    '/pdf-view',
                                                    arguments: <String, String>{
                                                      'url': response[index]['file_link']
                                                          .toString(),
                                                      'name': response[index]['file']
                                                          .toString(),
                                                    },
                                                  );
                                                }
