...
class _HomePageState extends State<BillingDetails> {
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    final msg = jsonEncode({
      ...
      "amount":forMonthController.text,
      ...
      "for_months":forMonthController.text,
    ...
    var response1 = await http.post(
      new Uri.https(
          BASE_URL, API_PATH + "/subscription-payment"),
      body: {
        "member_id":user_id.toString(),
        "razorpay_payment_id":response.paymentId.toString(),
        "amount":forMonthController.text,
    ...
    if (response1.statusCode == 200) {
      ...
      if (errorCode == 0) {
        ...
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => PaymentSuccessPage(paymentid: response.paymentId.toString())));
      } else {
        showAlertDialog(
  ...
  Future _getActivityCategories() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        subscriptionAmountController = TextEditingController(text: data['Response']['net_subscription'].toString() );
        netSubsController = TextEditingController(text: data['Response']['net_subscription'].toString() );
        plusNetSubsController = TextEditingController(text: data['Response']['total_subscription_amt'].toString());
        netPayController = TextEditingController(text: data['Response']['total_payable'].toString());
        ...
        total_advance=data['Response']['total_advance']!=null?data['Response']['total_advance'].toString():'';
        ...
        for_months=forMonthController.text;
        subscription_amt=data['Response']['total_subscription_amt'].toString();
        ...
        housenum = data['Response']['house_number'].toString();
        sector = data['Response']['sector_name'].toString();
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: Container(child:
        SingleChildScrollView(child: _buildCategoryItem()),),
  ...
  Widget CustomDialog({String title, String description, String applyButtonText, String cancelText}){
    ...
    return Dialog(
      ...
      elevation: 0.0,
      backgroundColor: Colors.transparent,
      child: dialogContent(context,title, description,applyButtonText,cancelText),
    );
  }
  dialogContent(BuildContext context, String title,String description, String applyButtonText,String cancelText) {
    return Stack(
      children: <Widget>[
        Container(
                      ...
                      Align(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () async {
                            ...
                            openCheckout(num.parse(netPayController.text.toString())*100);
                            Navigator.of(context).pop(false);
                          },
                          child: Text(
                            applyButtonText,
                ...
                child: Container(
                  ...
                  child: Column(children: <Widget>[
                                  ...
                                  Container(
                                    child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            hintStyle:
                                            TextStyle(color: Color(0xffcbf3eb), fontSize: 16),
                            ...
                            child: Column(
                                children: <Widget>[
                                  ...
                                  Container(
                                    child: TextFormField(
                                        enabled: false,
                                        initialValue: response['net_pay_arrears'].toString(),
                                        keyboardType: TextInputType.text,
                                        cursorColor: Color(0xff000000),
                                        style: normalText6,
                                        textCapitalization: TextCapitalization.sentences,
                                    ...
                                    child: TextFormField (
                                        ...
                                        onChanged: (String newValue) async {
                                          if(newValue.length != 0){
                                            setState(() {
                                              String amt = (int.parse(subscriptionAmountController.text.toString())*int.parse(newValue)).toString();
                                              netSubsController = TextEditingController(text: amt);
                                              plusNetSubsController = TextEditingController(text : amt);

                                              String payableAmt = (double.parse(response['total_pay_arrear'].toString())+
                                                  (double.parse(plusNetSubsController.text.toString()))+(double.parse(response['round_off'].toString()))).toString();
                                              String finalPayableAmt = (double.parse(payableAmt) - double.parse(discount)).toString();
                                              netPayController = TextEditingController(text: finalPayableAmt.split(".0").first);

                                              if(newValue != "1") {
                                                setState(() {
                                                  DateFormat format = DateFormat("MMM yyyy");
                                                  var newDate = new DateTime(format.parse(subscr_to_date).year,format.parse(subscr_to_date).month+(int.parse(newValue)-1), format.parse(subscr_to_date).day);
                                                  subs_to_date = DateFormat.yMMM().format(newDate);
                                                });
                                              }
                                            });
                                          }
                                             ...
                                             setState(() {
                                                 netSubsController = TextEditingController(text: net_subscription);
                                                 netPayController =  TextEditingController(text : net_payable);
                                                 plusNetSubsController = TextEditingController(text : subscription_amt);
                                          ...
                                          //You are here
                                          /*final msg = jsonEncode({
                                            "house_no" : response['houseDet']['house_number'],
                                            "sector" : response['houseDet']['sector_name'],
                                            "for_months" : forMonthController.text,
                                            "penalty_rate" : "12",
                                            "member_id" : user_id
                                          });
                                          ...
                                          var response1 = await http.post(
                                            new Uri.https(BASE_URL, API_PATH + "/get-subscription-details"),
                                            body: {
                                              "house_no":response['houseDet']['house_number'],
                                              "sector":response['houseDet']['sector_name'],
                                              "for_months": forMonthController.text,
                                          ...
                                          if (response1.statusCode == 200) {
                                            ...
                                            if (errorCode == 0) {
                                              setState(() {
                                             //   subscriptionAmountController = TextEditingController(text: data['Response']['total_subsc'].toString() );
                                                netSubsController = TextEditingController(text: data['Response']['net_subs'].toString() );
                                                plusNetSubsController = TextEditingController(text: data['Response']['total_subsc'].toString());
                                                netPayController = TextEditingController(text: data['Response']['total_payable'].toString() );
                                                total_arrear=data['Response']['total_arrear'].toString();
                                                prev_arrear=data['Response']['prev_arrear'].toString();
                                                prev_auth_chrg=data['Response']['auth_charge'].toString();
                                  ...
                                  Container(
                                    child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            hintStyle: TextStyle(color: Color(0xff686868), fontSize: 16),
                                            fillColor:  Color(0xffcbf3eb),
                                            filled: true)),
                                  ),
                                ]
                    ...
                    Container(
                        ...
                        child: Text("Final Payment", style: normalText6)),
                    const SizedBox(height: 15.0),
                    Row(
                        children: <Widget>[
                          Expanded(
                            child: Column(
                                children: <Widget>[
                                  ...
                                  Container(
                                    child: TextFormField(
                                        enabled: false,
                                        initialValue: response['total_pay_arrear'].toString(),
                                        keyboardType: TextInputType.text,
                                        cursorColor: Color(0xff000000),
                                        style: normalText6,
                                        textCapitalization: TextCapitalization.sentences,
                                  ...
                                  Container(
                                    child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            hintStyle: TextStyle(color: Color(0xffcbf3eb), fontSize: 16),
                                            fillColor: Color(0xffcbf3eb),
                                            filled: true)),
                                  ),
                                ]
                    ...
                    const SizedBox(height: 15.0),
                    Container(child: Text("Subscription Paid: From: $subs_from_date To: $subs_to_date", style: normalText6)),
                    ...
                    Container(
                      ...
                      child: ButtonTheme(
                        ...
                        child: RaisedButton(
                          ...
                          color: Color(0xff54d3c0),
                          onPressed: () async {
                            if(forMonthController.text.toString().length == 0){
                              Fluttertoast.showToast(
